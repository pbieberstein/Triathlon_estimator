...
shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
      ...
      column(12,
             ...
             column(6, numericInput("Seconds:",
                                    ...
                                    value = 30,
                                    inputId = "swim_sec"))),
      helpText(textOutput("swim_time"), align = "center"),
      ...
      column(12,
             column(12, 
                    numericInput(
                                 ...
                                 value = 20,
                                 inputId = "bike_pace"))),
      helpText(textOutput("bike_time"), align = "center"),
      ...
      column(12,
             ...
             column(6, numericInput("Seconds:",
                                    ...
                                    value = 30,
                                    inputId = "run_sec"))),
      helpText(textOutput("run_time"), align = "center"),
      
      tags$hr(),
      
      # Option of including transition times
      checkboxInput('showPanel1', 'Include Transition times', FALSE),
  ...
  mainPanel(br(),h1(textOutput("total_time"), align = "center", style = "font-size: 100px; font-size: 14vw;"),
            ...
            checkboxInput('showPanel2', 'Adjust Distances', FALSE),
                               ...
                               h3("Adjust Course Distances", align = "center"),
                                       ...
                                       column(12,
                                              ...
                                              column(4, numericInput("Run Distance (mi):",
                                                                     ...
                                                                     step=0.1,
                                                                     inputId = "run_dist"))),
                               br(), br(), br(), br()) # So that gray box extends below text
            )
